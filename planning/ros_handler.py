...
class ROSHandler():
    ...
    def detection_data_cb(self, msg):
        ...
        for i, object in enumerate(msg.objects):
            object_list.append({'X': object.position.x, 'Y': object.position.y, 'theta': math.radians(object.heading.data), 'type': 'physical', 'id': i, 'length': 9.0, 'v': object.velocity.data})
