...
pub_pr1_vel_prof = rospy.Publisher('/pr1_vel_prof', MarkerArray, queue_size=1)
...
save_.to_csv('./paths/PreRound1b.csv', final_tr)
save_.to_txt('./ids/PreRound1b_id.txt', final_ids)
