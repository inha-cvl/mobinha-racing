...
class Planning():
    ...
    def setting_values(self):
        ...
        self.gpp = GlobalPathPlanner('KCity')#self.RH.map_name)
    ...
    def executed(self):
        ...
        while not rospy.is_shutdown() and not self.shutdown_event.is_set():
            while self.first_initialized:
                ...
                #path spline
                interped_path, first_R, interped_vel = ph.interpolate_path(updated_path, min_length=int(LOCAL_PATH_LENGTH/2))
                ...
                planned_vel = self.gmv.smooth_velocity_plan(self.RH.current_velocity, local_max_vel, first_R)
                ...
                self.RH.publish2(interped_path,first_R, planned_vel, target_velocity)
