...
def calculate_R_list(points, base_offset=2, step_size=15):
    Rs = []
...
def interpolate_path(final_global_path, min_length=100, sample_rate=3, smoothing_factor=15.0, interp_points=10):
